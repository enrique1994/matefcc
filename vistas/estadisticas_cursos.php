...
$stmt = $DB_con->prepare("SELECT * FROM curso WHERE id_profesor=:user_id");
$stmt->execute(array(":user_id"=>$user_id));
...
<head>
  ...
  <title>SSAP | Estadísticas cursos</title>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Cursos que he impartido</h3>
...
<a href="estadisticacal.php?a=<?php echo $curso['nrc']?>"> <?php echo $curso['nrc']."<br>"; }?>
</a>
        </div>
        <!-- /.box-body -->
