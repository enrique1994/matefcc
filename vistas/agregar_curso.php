...
<head>
  ...
  <title>SSAP | Agregar Curso</title>
      ...
      <p id="errmsg_valid">Corrige los errores en el formulario</p>
        ...
        <div class = "row">
            ...
            <form role="form" id="demo-form"  method="POST">
              ...
              <br>
              <div >
              <input class="form-control" type="number" name="seccion" placeholder="Sección" data-parsley-validar-tam="3">
              </div>
              <br>
              <div >
              Días:
              <select class="form-control" id="dias" name="dias" >
                 <option value="Lunes-Martes-Jueves">Lunes-Martes-Jueves</option>
...
<script src="../js/parsley.js"></script>
   <!-- script para validacion -->
      ...
      <!-- script para el registro -->
        <script src="../scripts/agregar_curso.js"></script>
</body>
</html>
