        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Elija la materia para la búsqueda</h3>
              <br>
         ...
         <form id ="form" action ="dibujarGrafica.php" method="post" name="formulario1">
        
			Búsqueda a realizar: 
			
            <SELECT id="menu" NAME="busq" >
                <OPTION VALUE="0" SELECTED>Opción de búsqueda </OPTION>
                ...
                <OPTION VALUE="4">Estructura de datos </OPTION>
                <OPTION VALUE="5">Programacion Distribuida </OPTION>
                <OPTION VALUE="6">Aplicaciones web </OPTION>
                <OPTION VALUE="7">Programacion paralela y concurrente </OPTION>
            </SELECT>
