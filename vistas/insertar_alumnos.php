...
<head>
  ...
  <title>SSAP | Inscribir Alumnos</title>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Inscribir alumnos</h3>
        ...
        <div class = "row">
            ...
            <form role="form" id="form"  method="POST">
              ...
              Nrc:
                ...
                <input type="text" class="form-control" name="nrc" id="nrc" value="<?php echo $v1;?>" disabled>
...
<script src="../js/parsley.js"></script>
   <!-- script para validacion -->
      ...
      <!-- script para el registro -->
        <script src="../scripts/insertar_alumnos.js"></script>
</body>
</html>
