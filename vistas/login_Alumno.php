...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form method="post">
      ...
      <div class="row">
        <div class="col-xs-4">
          <button name="btn-login" type="submit" class="btn btn-primary btn-block btn-flat">Entrar</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
	<hr>
    <a href="registro_Alumno.html" class="text-center">Registrarse en el sistema</a>
