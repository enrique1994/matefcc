...
<head>
  ...
  <title>SSAP | Editar Alumnos</title>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Editar alumnos</h3>
      ...
      <p id="errmsg_valid">Corrige los errores en el formulario</p>
        ...
        <div class = "row">
            ...
            <form role="form" id="form"  method="POST">
                Pega aquí la lista de las matriculas de los alumnos.
                <br>
              Nrc:

                <!--<input type="text" class="form-control" name="nrc" id="nrc" value="<?php echo $v1;?>"> -->
                <select class="form-control" id="nrc" name="nrc">
                <?php
                ...
                <textarea class="form-control" id="matriculas" rows="10" col="9"></textarea>
                <br><br>
...
<script src="../js/parsley.js"></script>
   <!-- script para validacion -->
      ...
      <!-- script para el registro -->
        <script src="../scripts/editar_alumnos.js"></script>
</body>
</html>
