...
{
 $profesor->redirect('home_profesor.php');
}
...
<div class="login-box">
  <div class="login-logo Estilo1">
    <a href="../../index2.html"><strong>Inicio de sesión Profesor</strong></a>  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
	...
	<hr>
    <a href="registro_Profesor.html" class="text-center">Registrarse en el sistema</a>
