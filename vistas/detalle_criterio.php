...
$stmt2 = $DB_con->prepare("SELECT * FROM criterios_evaluacion WHERE id_parcial_cri=:user_id");
$stmt2->execute(array(":user_id"=>$id));
...
<head>
  ...
  <title>SSAP | Calificaciones finales</title>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Calificación final</h3>
              <br>
              <div class="box-tools">
